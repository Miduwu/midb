...
async function main() {
    ...
    if (existsSync(`${REPO_FOLDER}/docs`)) {
        ...
        for (const folder of folders) {
            // Cleaning purposes.
            if (existsSync(`${FINAL_DOCS_FOLDER}/${folder}`)) {
                rmSync(`${FINAL_DOCS_FOLDER}/${folder}`, { recursive: true })
            }

            // Create the folder.
            mkdirSync(`${FINAL_DOCS_FOLDER}/${folder}`)

            cpSync(`${REPO_FOLDER}/docs/${folder}`, `${FINAL_DOCS_FOLDER}/${folder}`, {
                recursive: true
            })
        }
